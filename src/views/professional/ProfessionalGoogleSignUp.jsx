...
<EntryLevelRightSideContainer formTitle="Google Sign up" formWidth="col-lg-8 col-md-8 " formHeaderClassName="signup-heading" form={<ProfessionalSocialMediaForm/>} formFooterQuestion="Already have an account?" footerNavigationLink="/" footerNavigateLinkContent="Sign in" />
</div>
</div>
)
}
